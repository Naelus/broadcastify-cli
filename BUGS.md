...
- **Next:** Run longer retained windows/full days, score event recall and unsupported critical claims against the evidence corpus, decide whether to add Qwen ForcedAligner or a Whisper-alignment second pass, and isolate/benchmark VibeVoice on multi-speaker and long scanner windows before considering either default.
