...
| Vulkan | whisper.cpp Vulkan | sherpa-onnx CPU preview; Community-1 upgrade | llama.cpp Vulkan | Exact `historical-validation` completed the joined AMD Radeon 890M profile in 9.199 seconds (2.547/0.321/5.626). Its 23.9-hour speaker run completed in 1,951.971 seconds at 0.0227 RTF with 91.05% Community-relative speech coverage; exact `historical-validation` passed 219 hardened tests and a real kill/resume/cache-commit proof |
