...
| Vulkan | whisper.cpp Vulkan | pyannote CPU | llama.cpp Vulkan | Exact current `historical-validation` passed 194 hardened tests and completed the joined proof on AMD Radeon 890M in 11.817 seconds (2.314/3.031/5.548); exact `historical-validation` retains the protected offline Web-job proof; full-day CPU diarization timing remains |
