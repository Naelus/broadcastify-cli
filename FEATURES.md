...
| Local Library | Validated | Five-stage timeline, playback, transcript preview, stale-result detection, retained-versus-temporary storage, schedule-aware feed backlog/last-known source coverage, guarded retrying whole-feed deletion with forced Windows media-handle disposal, selector-driven quota-safe Resume/prioritize, safe orphan cleanup, and exact per-day resume/upgrade/review actions. |
