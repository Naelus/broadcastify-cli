...
| AMD Vulkan/Linux | whisper.cpp Vulkan | sherpa-onnx CPU preview; Community-1 upgrade | llama.cpp Vulkan | Exact `historical-validation` passed 212 hardened tests and completed the current preview profile in 9.199 seconds on Radeon 890M; five-minute preview returned 19 turns in 6.634 seconds |
