...
| AMD Vulkan/Linux | whisper.cpp Vulkan | pyannote CPU fallback | llama.cpp Vulkan | Exact current `historical-validation` passed 194 hardened tests and completed the joined profile in 11.817 seconds on Radeon 890M; protected retained-audio Web job also validated |
